...
public class MavenArtifactTestUtils
{
    ...
    public static Gav geGavFromGAVTC(String gavtc)
    {
        ...
        return new Gav(groupId, artifactId, version, classifier, type, null, null, null, false, null, false, null);
    }
    ...
    public static MavenArtifact getArtifactFromGAVTC(String gavtc)
    {
        ...
        MavenArtifact artifact = new MavenRepositoryArtifact(gav)
        {
    ...
    public static Artifact getPOMArtifact(Artifact artifact)
    {
        Gav gav = new Gav(artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(),
                          artifact.getClassifier(), "pom", null, null, null, false, null, false, null);
